    ...
    <div id="app" class="container border shadow mb-4">
      ...
      <div class="row mb-3">
        ...
        <div class="col">
          ...
          <input type="number" step="1" class="form-control" v-model="id_medico" />
        </div>
        <div class="col">
          <label>Id users</label>
          <input type="number" step="1" class="form-control" v-model="id_users" />
        </div>
        <div class="col">
          <label>Status</label>
...
setTimeout(function(){location.reload()},5000);
    ...
    deleteForm() {
      axios({
        method: "delete",
        url: "https://proyecto-tedw.herokuapp.com/consultas/" + this.id_consulta,
      })
        .then(function(response) {
          console.log(response);
          Vue.$toast.open({
...
setTimeout(function(){location.reload()},5000);
    ...
    updateForm() {
      axios
        .put("https://proyecto-tedw.herokuapp.com/consultas/" + this.id_consulta, {
        sintomas: this.sintomas,
        id_medico: this.id_medico,
        id_users: this.id_users,
        status: this.status,
